    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        try
        {
            ...
            var definitions = new[]
            {
                ...
                new MenuSeedRow("positions", "Positions", "/positions", null, 30, "briefcase"),
                new MenuSeedRow("sites", "Sites", "/sites", null, 40, "mappin"),
                new MenuSeedRow("organization", "Organization", "/organization/setup", null, 50, "settings"),
                new MenuSeedRow("user-management", "User management", "/user-management", null, 60, "shield"),
